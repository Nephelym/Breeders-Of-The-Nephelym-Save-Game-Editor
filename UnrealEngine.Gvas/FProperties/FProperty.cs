...
public abstract class FProperty
{
    ...
    public static IEnumerable<FProperty> ReadFrom(BinaryReader reader, int count = -1)
    {
        ...
        var propertyType = FindPropertyTypeByName(propertyName);
        var propertyTypeName = propertyName;
        if (propertyType is null)
        {
            propertyTypeName = reader.ReadFString()!;
            propertyType = FindPropertyTypeByName(propertyTypeName)!;
